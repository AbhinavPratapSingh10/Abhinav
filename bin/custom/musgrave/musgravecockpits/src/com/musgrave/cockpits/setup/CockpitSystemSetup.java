 ...
 */
package com.musgrave.cockpits.setup;
...
import com.musgrave.cockpits.constants.MusgraveCockpitsConstants;
 ...
 */
@SystemSetup(extension = MusgraveCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MusgraveCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MusgraveCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MusgraveCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/musgravecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
