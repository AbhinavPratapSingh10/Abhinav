...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/musgravestorefront/electronics/en",
						"https://electronics.local:9002/musgravestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/musgravestorefront/electronics/en",
						"https://electronics.local:9002/musgravestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/musgravestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/musgravestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/musgravestorefront/electronics/en",
						"https://electronics.local:9002/musgravestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/musgravestorefront",
						"https://electronics.local:9002/musgravestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/musgravestorefront",
						"https://electronics.local:9002/musgravestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/musgravestorefront/electronics/en",
						"https://electronics.local:9002/musgravestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
