 ...
 */
package com.musgrave.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MusgraveFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MusgraveFulfilmentProcessConstants.PARENT_PROCESS);
